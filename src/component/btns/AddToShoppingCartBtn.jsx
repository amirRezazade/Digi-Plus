...
export default function AddToShoppingCartBtn({ product, quantity = 1 }) {
  ...
  return (
    <button disabled={product.stock === 0} onClick={addToCart} className={`cursor-pointer size-10 flex justify-center items-center border border-org rounded-xl fill-red bg-yel2 transition-colors duration-300 disabled:opacity-50 disabled:cursor-no-drop ${inCart && "fill-white bg-linear-270 from-[#DC2F02] to-[#FF7B00] scale-105"}`}>
