...
export default function NavbarProductsList() {
  return (
    <div className="absolute top-[180%]  group-hover:top-[149%] border border-light-gray shadow-sm group-hover:visible group-hover:opacity-100 transition-[opacity_top_visibility] duration-300 right-0 bg-white  px-5 py-3 rounded-2xl w-full lg:w-[90vw]  2xl:max-w-[1400px] ">
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 items-start">
        <ul className="relative flex flex-col divide-y divide-light-gray text-dark border-e border-light-gray">
          <li className="">
            <button className=" w-full py-3 flex items-center justify-between cursor-pointer transition-colors duration-300 hover:fill-red hover:text-red">
              ابزار و تجهیزات
              <span>
            ...
            <div className="absolute top-2 right-[110%] ">
              <div>
                <span className="title-style relative ps-4 text-dark font-semibold ">الکرونیکی</span>
                <ul className="text-gray text-sm ps-4 py-2 flex flex-col gap-1">
                  <NavbarLink text={"پیچ گوشتی"} to={"/"} />
                  <NavbarLink text={"پیچ گوشتی"} to={"/"} />
                  <NavbarLink text={"پیچ گوشتی"} to={"/"} />
                  <NavbarLink text={"پیچ گوشتی"} to={"/"} />
                </ul>
        ...
        <div className="hidden lg:inline-block xl:ps-4">
            ...
            <div className="flex items-center justify-between mt-2 pt-2 border-t border-light-gray">
              <button className="size-11 rounded-xl flex justify-center items-center gradient cursor-pointer">
                <svg class="m-0" width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_2099_13129)">
                    <path
