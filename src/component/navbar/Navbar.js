...
export default function Navbar() {
  return (
    <header>
      ...
      <nav className="custom-container flex justify-between items-center py-3.5 border-b border-light-gray">
        <ul className="flex items-center gap-5 text-gray text-sm">
          <li className="text-base text-white">
            <button className="flex items-center gap-1 pe-5 p-1 rounded-3xl gradient relative cursor-pointer">
              ...
              <span className="text-white px-3 ">دسته بندی محصولات</span>
              <span>
          ...
          <li>
            <button className="flex items-center gap-1 cursor-pointer rounded-[18px] p-2.5 hover:text-org hover:bg-light transition-colors duration-300">
              <span>
          ...
          <li>
            <NavLink to={"/shop"} className={"flex items-center gap-1 rounded-[18px] p-2.5 hover:text-org hover:bg-light transition-colors duration-300"}>
              <span>
          ...
          <li>
            <button className=" cursor-pointer rounded-[18px] p-2.5 hover:text-org hover:bg-light transition-colors duration-300">
