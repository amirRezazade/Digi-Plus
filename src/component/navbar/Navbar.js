    ...
    <header>
      ...
      <nav className=" fixed w-screen h-screen top-0 right-0 lg:static lg:h-auto lg:w-auto lg:mx-12 xl:mx-15 2xl:mx-auto 2xl:max-w-[1400px] bg-black/50 lg:bg-black/0">
        <div className="flex justify-between lg:items-center gap-3 lg:gap-0 lg:py-3.5 bg-white w-70 h-full lg:w-auto px-5 py-2.5 lg:px-0 flex-col lg:flex-row">
          ...
          <ul className="hidden order-2 lg:flex items-center gap-1.5 xl:gap-5 text-gray text-sm me-auto lg:ms-1 xl:ms-3">
            <li className="relative group rounded-[18px]  hover:text-org hover:bg-light transition-colors duration-300">
              <button className="flex items-center gap-1 cursor-pointer  p-2  xl:p-2.5  ">
                <span>
                  <svg class="_mi _before _svg" xmlns="http://www.w3.org/2000/svg" width="17" height="15" viewBox="0 0 20 16" fill="currentcolor">
            ...
            <li className="relative group rounded-[18px]  hover:text-org hover:bg-light transition-colors duration-300">
              <NavLink to={"/shop"} className="flex items-center gap-1   p-2  xl:p-2.5  ">
                <span>
                  <svg class="_mi _before _svg" xmlns="http://www.w3.org/2000/svg" width="12" height="16" viewBox="0 0 12 16" fill="currentcolor">
            ...
            <li className="relative group rounded-[18px]  hover:text-org hover:bg-light transition-colors duration-300">
              <button className="flex items-center gap-1 cursor-pointer   p-2  xl:p-2.5  ">
                <span>
                  <svg class="_mi _before _svg" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="currentcolor">
            ...
            <li className="relative group rounded-[18px]  hover:text-org hover:bg-light transition-colors duration-300">
              <button className="flex items-center gap-1 cursor-pointer  p-2  xl:p-2.5  ">
                <span>
                  <svg class="_mi _before _svg" xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14" fill="currentcolor">
          ...
          <div className="text-center order-5 pt-4 border-t border-light-gray lg:hidden">
