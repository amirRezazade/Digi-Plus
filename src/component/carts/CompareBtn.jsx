...
export default function CompareBtn({ product }) {
  ...
  return (
    <>
      <button onClick={() => addToCompare(product.id)} className="p-1.5 cursor-pointer relative group/item">
        <span className="stroke-gray hover:fill-org fill-gray">
          <svg width="20" height="20" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" strokeWidth="0.00032">
