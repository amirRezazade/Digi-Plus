...
export default function SpecialOffer() {
  ...
  return (
    <div className="custom-container flex flex-col xl:flex-row justify-between items-center lg:items-stretch lg:gap-5">
      ...
      {/* content  */}
      <div className="text-gray lg:w-2/3 mx-auto xl:w-1/2 xl:pl-8 mt-8 lg:mt-0 flex flex-col xl:justify-between gap-4 sm:gap-7 xl:gap-0 text-sm md:text-base ">
        ...
        <div>
          <button className="py-2.5 px-5 flex items-center gap-2 rounded-2xl gradient text-white transition-transform duration-300  hover:scale-105 ">
