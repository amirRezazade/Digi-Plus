...
export default function AmazingOffers() {
  ...
  return (
    <div className="custom-container sm:flex items-center gap-3 mb-50 relative bg-no-repeat  bg-center sm:bg-right  overflow-hidden bg-[url(../src/assets/images/bg-images/bg-line-vertical.png)] sm:bg-[url(../src/assets/images/bg-images/bg-line.png)] md:before:absolute md:before:w-26 md:before:h-full before:pointer-events-none md:before:left-0 md:before:top-0 md:before:bg-linear-90 md:before:from-white md:before:to-[rgba(255, 255, 255, 0)] md:before:z-10">
