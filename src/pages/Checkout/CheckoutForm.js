...
export default function CheckoutForm() {
  ...
  return (
    <div className="custom-container text-gray">
      ...
      <section className="flex flex-col lg:flex-row justify-between gap-5 mt-8">
        <div className="w-full lg:w-auto lg:grow p-3.5 sm:p-6 rounded-2xl  gray-shaddow border border-light-gray/50">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-y-2 gap-x-7 my-5" action="">
            <div>
              ...
              <input className="w-full my-2 border border-light-gray rounded-lg p-2 outline-0 focus:border-org" type="text" id="name" />
            </div>
            <div>
              <label className="cursor-pointer" htmlFor="last-name">
                نام خانوادگی <span className="text-red"> * </span>
              </label>
              <input className="w-full my-2 border border-light-gray rounded-lg p-2 outline-0 focus:border-org" type="text" id="last-name" />
            </div>
            <div>
              <label className="cursor-pointer" htmlFor="email">
                آدرس ایمیل<span className="text-red"> * </span>
              </label>
              <input className="w-full my-2 border border-light-gray rounded-lg p-2 outline-0 focus:border-org" type="email" id="email" />
            </div>
            <div>
              <label className="cursor-pointer" htmlFor="postal-code">
                کد پستی<span className="text-red"> * </span>
              </label>
              <input className="w-full my-2 border border-light-gray rounded-lg p-2 outline-0 focus:border-org" type="text" id="postal-code" />
            </div>
            <div>
              <label className="cursor-pointer" htmlFor="phone">
                تلفن<span className="text-red"> * </span>
              </label>
              <input className="w-full my-2 border border-light-gray rounded-lg p-2 outline-0 focus:border-org" type="tel" id="phone" />
            </div>
            <div>
              <label className="cursor-pointer" htmlFor="country">
                کشور / منطقه <span className="text-red"> * </span>
              </label>
              <input className="w-full my-2 border border-light-gray rounded-lg p-2 outline-0 focus:border-org" type="text" id="country" />
            </div>
            <div>
              <label className="cursor-pointer" htmlFor="Province">
                استان<span className="text-red"> * </span>
              </label>
              <input className="w-full my-2 border border-light-gray rounded-lg p-2 outline-0 focus:border-org" type="text" id="Province" />
            </div>
            <div>
              <label className="cursor-pointer" htmlFor="city">
                شهر<span className="text-red"> * </span>
              </label>
              <input className="w-full my-2 border border-light-gray rounded-lg p-2 outline-0 focus:border-org" type="text" id="city" />
            </div>
            <div>
              <label className="cursor-pointer" htmlFor="street">
                خیابان<span className="text-red"> * </span>
              </label>
              <input className="w-full my-2 border border-light-gray rounded-lg p-2 outline-0 focus:border-org" type="text" id="street" />
            </div>
            <div>
              <label className="cursor-pointer" htmlFor="addres">
                آدرس<span className="text-red"> * </span>
              </label>
              <input className="w-full my-2 border border-light-gray rounded-lg p-2 outline-0 focus:border-org" type="text" id="addres" />
            </div>
          </form>
        </div>
          ...
          <div className="p-4 rounded-2xl  gray-shaddow border border-light-gray/50">
            ...
            <div>
              <div className="flex justify-between items-center mt-5 ">
                ...
                <span className="text-lg text-dark font-bold">{formatedPrice(totalOriginalPrice)} $</span>
              </div>
              <button className="block w-full max-w-140 mx-auto py-3 text-lg rounded-lg sm-shaddow mt-6 gradient text-white cursor-pointer transition-transform duration-300 hover:scale-105">ثبت سفارش</button>
            </div>
          </div>
        </div>
      </section>
