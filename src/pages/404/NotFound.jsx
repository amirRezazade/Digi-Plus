...
import notFound from "../../assets/images/404page.png";
    ...
    <>
      ...
      <main className="custom-container mb-10">
        <div className="custom-container flex items-center gap-3 text-gray text-sm text-nowrap overflow-auto hidden-scrollbar my-5 lg:my-9 px-4">
          ...
          <span className="text-dark">404</span>
        </div>
        <img className="mx-auto pt-5" src={notFound} alt="not found" />
        <div className="text-center mt-8 text-sm sm:text-base!">
          <h4 className="text-sm sm:text-base!">متاسفانه صفحه ی مورد نظر شما پیدا نشد.</h4>
          <Link to={"/"} className="mt-3 inline-block text-org">
            رفتن به صفحه اصلی
          </Link>
        </div>
      </main>
